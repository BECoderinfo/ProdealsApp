...
class iosBusinessOrderDetailsScreen
    extends GetView<BusinessOrderDetailsController> {
  const iosBusinessOrderDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BusinessOrderDetailsController>(
      init: BusinessOrderDetailsController(),
      builder: (controller) {
        return WillPopScope(
          onWillPop: () {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                "${controller.orderDetails?.userId?.userName ?? ""}",
                                                style: TextStyle(
                                              ...
                                              Text(
                                                "${controller.orderDetails?.userId?.email ?? ""}",
                                                maxLines: 1,
